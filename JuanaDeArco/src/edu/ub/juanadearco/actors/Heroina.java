...
/**
 * Representa el nostre heroina. L'heroina manté una llista amb les gemmes
 * trobades
 *
 * @author Prog1
 */
public class Heroina extends AbstractActor {
    ...
    public void addClau(Clau clau) {
        claus[clausActuals] = clau;
        clausActuals++;
    }
   
    public static void trobades(){
            trobat=true;
    }

    public static boolean haTrobatLesClaus() {
        return (trobat || clausActuals==5);
    }
